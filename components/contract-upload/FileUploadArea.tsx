  ...
  return (
    <AnimatedAppear direction="up" duration={500}>
      <div className="relative w-full max-w-3xl mx-auto mt-8">
        {/* Background container with scale effect */}
        <div 
          className={`
            absolute inset-0
            ...
            ${isDragging
              ...
              : "border-gray-300 dark:border-gray-700 group-hover:border-blue-400 group-hover:bg-blue-50/50 dark:group-hover:border-blue-500 dark:group-hover:bg-blue-950/20"
            }
            ${error
        ...
        {/* Content container without scale */}
        <div
          {...getRootProps()}
          className="
            relative p-8
