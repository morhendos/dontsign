        ...
        try {
          ...
          controller.enqueue(
            `data: ${JSON.stringify({
              type: 'progress',
              stage: 'preprocessing',
              progress: ANALYSIS_PROGRESS.PREPROCESSING
            })}\n\n`
          );
          ...
          controller.enqueue(
            `data: ${JSON.stringify({
              type: 'progress',
              stage: 'preprocessing',
              progress: ANALYSIS_PROGRESS.ANALYSIS_START,
          ...
          // Start generating final summary
          controller.enqueue(
            `data: ${JSON.stringify({
              type: 'progress',
              stage: 'analyzing',
              progress: ANALYSIS_PROGRESS.SUMMARY_START
            })}\n\n`
          );
          ...
          // Summary generated, update progress
          controller.enqueue(
            `data: ${JSON.stringify({
              type: 'progress',
              stage: 'analyzing',
              progress: ANALYSIS_PROGRESS.SUMMARY_END
            })}\n\n`
          );
